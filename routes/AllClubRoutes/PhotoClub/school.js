...
router.get("/get-school-photo", async (req, res) => {
...
router.get("/get-students-photo", async (req, res) => {
...
router.get("/get-captain-photo", async (req, res) => {
...
router.get("/get-correspondent-photo", async (req, res) => {
  const { district, club, school } = req.query;
...
router.put("/make-captain-photo", async (req, res) => {
